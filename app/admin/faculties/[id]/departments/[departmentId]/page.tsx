...
export default async function DepartmentDetailPage({
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="rounded-2xl border border-slate-200 bg-white shadow-sm">
        <div className="border-b border-slate-100 p-6">
          <h2 className="text-lg font-bold text-[#031b46]">Profesores</h2>
        </div>

        {department.professors.length === 0 ? (
          <EmptyState label="Este departamento no tiene profesores asignados." />
        ) : (
          <div className="overflow-x-auto">
            <table className="w-full min-w-180 text-left">
              ...
              <tbody className="divide-y divide-slate-100">
                {department.professors.map((professor) => (
                  ...
                  >
                    <td className="px-6 py-4">
                      <CodePill value={professor.employeeCode} />
                    </td>
                    <td className="px-6 py-4">
                      <p className="text-sm font-bold text-slate-800">
